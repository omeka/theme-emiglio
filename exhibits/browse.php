...
<div id="secondary">
	...
	<div id="featured-exhibit" class="exhibit">
    <h3>Featured Exhibit</h3>
    <?php if ( $featuredExhibit ): ?>
      <h4><?php echo link_to_exhibit($featuredExhibit); ?></h4>
<div class="description"><?php echo nls2p(snippet($featuredExhibit->description,0,200)); ?></div>
    <?php else: ?>
