...
<div id="primary">
    ...
    <?php foreach (loop('collection') as $collection): ?>
        <div class="collection">
            ...
            <?php echo link_to_items_browse(__('View the items in %s', metadata($collection, 'rich_title', array('no_escape' => true))), array('collection' => $collection->id), array('class' => 'view-items-link')); ?>
